...
| 버전  | 날짜       | 변경 내용                                                                                                                                                                                                                                                                                                                                                             |
| ----- | ---------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2.8.0 | 2026-08-07 | 경험 정리 v3 개편 — 블록 트리 스키마 신설. `block_kind`, `block`(자기참조 트리, 1~5단계), `experience_meta`(EXPERIENCE 블록 메타, portfolio enum 재사용), `review`(첨삭 대상 마킹), `experience_map`(낙관적 잠금), `ai_experience_session`/`ai_experience_request`/`ai_commit_log`(AI 에이전트 세션·요청·커밋 롤백) 추가. 기존 `experience`/`portfolio` 스키마는 유지 |
